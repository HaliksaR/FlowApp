...
class GetUserSortedByLoginFlowUseCase(private val repository: AccountsRepository) {

    operator fun invoke(): Flow<List<UserEntity>> = repository.getUserSortedByLogin()
}