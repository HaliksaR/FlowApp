...
import ru.haliksar.flowapp.libraries.paging.notmutable.Action
import ru.haliksar.flowapp.libraries.paging.notmutable.PagingContract
import ru.haliksar.flowapp.libraries.paging.notmutable.Store
...
abstract class PagingViewModel<T : Any> : ViewModel(),
    ...
    final override val paging: Store<T> =
